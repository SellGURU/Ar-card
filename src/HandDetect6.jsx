...
const HandDetect6 = (props) => {
  ...
  const toggleCamera = () => {
    ...
    localStorage.setItem("cameraMode",!isFrontCamera?'back':'front')
  ...
  useEffect(() => {
    let mode = localStorage.getItem("cameraMode")
    // alert(mode)
    setIsFrontCamera(mode !='front'?true:false)
  })
  useConstructor(() => {
    // document.onload = () => {
    //   configure();
