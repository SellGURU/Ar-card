        ...
        <>
            <div style={{overflow:'hidden'}}>
                <div style={{display:'flex',zIndex:20,top:20,justifyContent:'center',width:'100%',position:'absolute'}}>
                    <video id="dragAbleAi" playsInline ref={videoRef} height={'138px'} style={{borderRadius:'100%'}} className="pk_video" preload="auto" width={'138px'} autoPlay={!isRecording} loop muted >
